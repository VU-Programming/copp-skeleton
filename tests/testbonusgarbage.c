...
void testGC1(void) {
    ...
    step();
    assert(tos() == 18);
    assert(is_heap_freed(reference) == false);
    steps(2);
...
void testGC2(void) {
    ...
    step();
    assert(is_heap_freed(ref1) == false);
    assert(is_heap_freed(ref2) == true);
    steps(4);
    assert(is_heap_freed(ref1) == true);
    assert(is_heap_freed(ref2) == true);
    step();
...
void testGC3(void) {
    ...
    word_t ref3 = tos();
    steps(10);
    assert(is_heap_freed(ref3) == false);
    steps(5);
    assert(tos() == 50);
    step();
    assert(is_heap_freed(ref3) == false);
    steps(4);
    assert(is_heap_freed(ref3) == true);
    assert(is_heap_freed(ref1) == false);
...
void testGC4(void) {
    ...
    steps(9);
    assert(is_heap_freed(reference1) == false);
    assert(is_heap_freed(reference2) == false);
    steps(2);
    assert(tos() == 1);
    steps(2);
    assert(is_heap_freed(reference1) == false);
    ...
    assert(tos() == 1);
    steps(2);
    assert(is_heap_freed(reference1) == true);
    assert(is_heap_freed(reference2) == true);
    step();
